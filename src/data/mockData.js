...
export const liveParameters = [
  ...
  {
    label: "DO (Dissolved O2)",
    value: 6.5,
    unit: "mg/L",
    min: 0,
    max: 10,
    thresholds: { warning: 4, critical: 2 },
  },
  {
    label: "COD",
    value: 48,
...
export const recentAlerts = [
  ...
  },
  {
    ...
    message:
      "pH level at Station C1 exceeded warning threshold. Immediate action required.",
    time: "Yesterday",
    station: "Station C1",
  },
];
...
export const upcomingFeatures = [
  {
    ...
    description:
      "Machine learning algorithms that automatically detect unusual patterns in water quality data and predict potential issues before they occur.",
    icon: "brain",
  ...
  },
  {
    ...
    description:
      "Native iOS and Android apps for field technicians to receive real-time alerts, view dashboards, and submit reports from anywhere.",
    icon: "smartphone",
    status: "Planning",
    progress: 30,
    eta: "Q3 2026",
  ...
  },
  {
    ...
    description:
      "Automated compliance report generation with customizable templates, scheduled exports, and regulatory format support.",
    icon: "fileText",
    status: "In Development",
    progress: 60,
    eta: "Q2 2026",
  ...
  },
  {
    ...
    description:
      "Seamless integration with third-party IoT sensors and devices for expanded monitoring capabilities and data collection.",
    icon: "cpu",
    status: "Research",
    progress: 15,
    eta: "Q4 2026",
  ...
  },
  {
    ...
    description:
      "Unified dashboard to monitor and compare multiple treatment facilities from a single interface with aggregated analytics.",
    icon: "building",
    status: "Planning",
    progress: 40,
    eta: "Q3 2026",
  ...
  },
  {
    ...
    description:
      "Voice-controlled interface for hands-free operation and quick data queries using natural language processing.",
    icon: "mic",
    status: "Research",
    progress: 10,
    eta: "Q1 2027",
