...
const Sidebar = () => {
    ...
    const features = [
        { icon: Monitor, title: 'Command Center Dashboard', description: 'Real-time water quality metrics with animated gauges and trend charts', color: 'cyan' },
        { icon: Activity, title: 'Live Monitoring', description: 'Multi-station parameter comparison with live data streaming', color: 'green' },
        { icon: MapIcon, title: 'Geo-Spatial Mapping', description: 'Interactive Leaflet maps with station locations and status', color: 'blue' },
        { icon: BarChart2, title: 'Advanced Analytics', description: 'Data analytics, trends, and predictive insights', color: 'purple' },
        { icon: Bell, title: 'Alert Management', description: 'Priority-based alerts with acknowledgment workflow', color: 'red' },
        { icon: FileText, title: 'Compliance Reports', description: 'Automated reports with PDF, Excel, CSV export', color: 'amber' },
        { icon: Shield, title: 'Enterprise Security', description: '2FA, SSO support, and role-based access control', color: 'emerald' },
        { icon: Globe, title: 'Multi-Language', description: 'Support for English, Hindi, and Marathi', color: 'pink' },
        { icon: Zap, title: 'Real-Time Updates', description: 'Live sensor data with instant threshold alerts', color: 'yellow' },
        { icon: Database, title: 'Data Export', description: 'Export data in multiple formats for analysis', color: 'indigo' },
        { icon: Cloud, title: 'Cloud Integration', description: 'Seamless cloud sync and backup capabilities', color: 'sky' },
        { icon: Smartphone, title: 'Responsive Design', description: 'Works perfectly on desktop, tablet, and mobile', color: 'orange' },
    ];
    ...
    return (
        <>
            <motion.aside
                ...
                style={{
                    background: 'linear-gradient(180deg, rgba(8, 12, 22, 0.98) 0%, rgba(5, 8, 15, 0.95) 100%)',
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        >
                            ...
                            <div className="relative w-12 h-12 rounded-xl overflow-hidden border border-cyan-500/30">
                                <img src="/logo.jpg" alt="AquaTracker" className="w-full h-full object-cover" />
                            </div>
                        </motion.div>
                        <div>
                ...
                >
                                ...
                                {({ isActive }) => (
                                    <>
                                        ...
                                        <item.icon
                                            ...
                                            style={isActive ? { filter: 'drop-shadow(0 0 8px rgba(0, 242, 255, 0.6))' } : {}}
                                        />
                                        ...
                                        {/* Arrow for active */}
                                        {isActive && (
                                            <ChevronRight size={14} className="ml-auto text-cyan-400 relative z-10" />
                                        )}
                    ...
                    <motion.div variants={itemVariants}>
                        ...
                        >
                            ...
                            <ChevronRight size={14} className="ml-auto text-purple-400 relative z-10" />
                        </motion.button>
                    </motion.div>
                </motion.nav>
                ...
                <div className="p-4 border-t border-white/5">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-mono text-green-400 font-medium">ONLINE</span>
                            <span className="text-[10px] text-gray-600 ml-auto font-mono">v2.4.3</span>
                        </div>
                    </motion.div>
                </div>
            </motion.aside>
                ...
                {showFeatures && (
                    ...
                    >
                        <motion.div
                            ...
                            style={{
                                background: 'linear-gradient(135deg, rgba(8, 12, 22, 0.98) 0%, rgba(15, 20, 35, 0.95) 100%)',
                            ...
                            <div className="flex items-center justify-between p-6 border-b border-white/10">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Enterprise Water Quality Monitoring Platform</p>
                                    </div>
                                </div>
                                <motion.button
                                    onClick={() => setShowFeatures(false)}
                            ...
                            <div className="p-6 overflow-y-auto max-h-[calc(85vh-120px)]">
                                    ...
                                    {features.map((feature, index) => (
                                        ...
                                        >
                                            <div className="flex items-start gap-3">
                                                <div className={`w-10 h-10 rounded-lg bg-gradient-to-br ${getColorClasses(feature.color)} flex items-center justify-center shrink-0`}>
                                ...
                                <div className="mt-6 pt-6 border-t border-white/10 text-center">
                                    <p className="text-sm text-gray-500">
                                        <span className="text-cyan-400 font-semibold">AquaTracker v2.4.3</span> • Enterprise Core Edition
                                    </p>
                                </div>
                            </div>
                        </motion.div>
