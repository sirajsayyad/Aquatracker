...
import { Bell, AlertTriangle, CheckCircle, Info, AlertOctagon, X, ExternalLink } from 'lucide-react';
...
const AlertsPanel = () => {
    ...
    const getAlertIcon = (type) => {
        switch (type) {
            ...
            case 'danger': return <AlertOctagon size={16} className="text-red-400" />;
    ...
    const getAlertStyles = (type) => {
        switch (type) {
            case 'warning': return 'border-l-amber-500 hover:border-amber-500/50';
            case 'success': return 'border-l-green-500 hover:border-green-500/50';
            case 'danger': return 'border-l-red-500 hover:border-red-500/50';
            default: return 'border-l-cyan-500 hover:border-cyan-500/50';
        }
    };
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 font-mono">System notifications</p>
                    </div>
                </div>
