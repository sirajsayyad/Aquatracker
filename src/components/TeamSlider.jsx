...
import { ChevronLeft, ChevronRight, Users, Mail, ExternalLink } from 'lucide-react';
...
const TeamSlider = () => {
    ...
    const getStatusColor = (status) => {
        switch (status) {
            ...
            case 'busy': return 'bg-amber-500 shadow-[0_0_8px_#f59e0b]';
            case 'away': return 'bg-gray-500 shadow-[0_0_8px_#6b7280]';
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 font-mono">{teamMembers.length} Active Members</p>
                    </div>
                </div>
                            ...
                            <div className="group p-5 rounded-xl bg-white/5 border border-white/10 hover:border-cyan-500/30 transition-all duration-300 h-full">
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <div className="relative">
                                        <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${getAvatarGradient(index)} flex-center text-white font-bold text-lg shadow-lg`}>
                                            {member.initials}
                                        </div>
            ...
            <div className="flex items-center justify-center gap-2 mt-6">
                {Array.from({ length: teamMembers.length - cardsPerView + 1 }).map((_, i) => (
                    <button
                        key={i}
