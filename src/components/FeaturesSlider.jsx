      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="p-6 rounded-xl bg-white/5 border border-white/10">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                ...
                <span
                  className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold border ${getStatusColor(upcomingFeatures[currentIndex].status)}`}
                >
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <span className="font-mono">
                Expected: {upcomingFeatures[currentIndex].eta}
              </span>
            </div>
          </div>
          ...
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 flex flex-col justify-between">
            <div>
              <h5 className="text-sm font-bold text-gray-400 mb-4 uppercase tracking-wider">
