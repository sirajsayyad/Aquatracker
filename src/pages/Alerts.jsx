...
const Alerts = () => {
  ...
  const alerts = [
    {
      ...
      message: "Station C1 pH level exceeded 9.5. Immediate action required.",
      time: "2 min ago",
      station: "Station C1",
      status: "active",
      priority: "high",
    },
    {
      ...
      message:
        "Station A3 turbidity at 3.8 NTU, approaching warning level of 4.0 NTU.",
      time: "15 min ago",
      station: "Station A3",
      status: "active",
      priority: "medium",
    },
    {
      ...
      message: "Pump Unit B2 maintenance scheduled for tomorrow at 10:00 AM.",
      time: "1 hour ago",
      station: "Pump B2",
      status: "acknowledged",
      priority: "low",
    },
    {
      ...
      message:
        "COD levels at Station D4 have returned to normal operating range.",
      time: "2 hours ago",
      station: "Station D4",
      status: "resolved",
      priority: "low",
    },
    {
      ...
      title: "System Update",
      message:
        "New firmware update available for flow sensors. Schedule update during off-peak hours.",
      time: "3 hours ago",
    ...
    },
    {
      ...
      message:
        "DO sensor at Station E2 reporting erratic readings. Manual verification required.",
      time: "4 hours ago",
      station: "Station E2",
    ...
    },
    {
      ...
      message:
        "Minor power fluctuation detected at Station A1. Backup systems activated.",
      time: "5 hours ago",
      station: "Station A1",
      status: "resolved",
      priority: "medium",
    },
    {
      ...
      message:
        "Monthly compliance report for December 2025 is ready for review.",
      time: "Yesterday",
      station: "System",
      status: "active",
      priority: "low",
  ...
  const getAlertIcon = (type) => {
    switch (type) {
      case "critical":
        return <AlertOctagon size={18} className="text-red-400" />;
      case "warning":
  ...
  const filteredAlerts = alerts.filter((alert) => {
    const matchesFilter =
      filter === "all" || alert.type === filter || alert.status === filter;
    const matchesSearch =
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <span
                    className={`text-[10px] px-2 py-0.5 rounded-full border ${getStatusBadge(alert.status)}`}
                  >
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-4 text-sm text-gray-500 mb-6">
                <span className="flex items-center gap-1">
                  <Clock size={14} /> {selectedAlert.time}
                </span>
                <span className="flex items-center gap-1">
                  <MapPin size={14} /> {selectedAlert.station}
                </span>
              </div>
