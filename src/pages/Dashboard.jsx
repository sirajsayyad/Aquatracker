...
const Dashboard = () => {
  ...
  return (
    ...
    >
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="tag-cyber tag-purple">
              <span
                ...
                style={{ background: "#bd00ff", boxShadow: "0 0 6px #bd00ff" }}
              />
              LIVE MODEL
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/5 hover:border-green-500/30 transition-all group">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="tag-cyber tag-success text-[8px] py-0.5">
                  SAFE
                </span>
              </div>
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/5 hover:border-amber-500/30 transition-all group">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="tag-cyber tag-warning text-[8px] py-0.5">
                  ACTION REQ
                </span>
              </div>
              ...
              <p className="text-xs text-gray-500">
                Recommended adjustment to counteract predicted turbidity surge
      ...
      {/* === MAIN CHART === */}
      <motion.div className="holo-panel p-6 relative" variants={itemVariants}>
