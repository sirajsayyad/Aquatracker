...
import { Droplets, Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles, User, Shield, KeyRound } from 'lucide-react';
            ...
            >
                ...
                >
                    ...
                    <div className="relative flex bg-white/5 rounded-xl p-1 mb-8">
                        ...
                        />
                        <button
                            className={`relative flex-1 py-2.5 text-sm font-medium transition-colors ${isLogin ? 'text-cyan-400' : 'text-gray-400 hover:text-gray-300'
                                }`}
                        ...
                        <AnimatePresence mode="wait">
                            {!isLogin && (
                                ...
                                >
                                    ...
                                    <div className="relative group">
                                        <KeyRound className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-cyan-400 transition-colors" size={18} />
                                        <input
                        ...
                        {isLogin && (
                            <div className="flex items-center justify-between text-sm">
                                <label className="flex items-center gap-2 text-gray-400 cursor-pointer group">
                                    <input type="checkbox" className="w-4 h-4 rounded border-white/20 bg-white/5 text-cyan-500 focus:ring-cyan-500/30" />
